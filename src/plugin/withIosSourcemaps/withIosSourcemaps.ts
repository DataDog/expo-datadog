...
const getDatadogXCodeCommand = (
  ...
  `../node_modules/.bin/datadog-ci react-native xcode \`\\\"$NODE_BINARY\\\"${
    serviceName ? ` --service ${serviceName}` : ""
  } --print \\\"require('path').dirname(require.resolve('react-native/package.json')) + '/scripts/react-native-xcode.sh'\\\"\``;
